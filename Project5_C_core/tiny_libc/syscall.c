...
void* sys_get_pageaddr(void *addr)
{
    return invoke_syscall(SYSCALL_F, addr, IGNORE, IGNORE, IGNORE, IGNORE);
}

void* sys_get_snap_page(int key)
{
    return invoke_syscall(SYSCALL_SNP_GET, key, IGNORE, IGNORE, IGNORE, IGNORE);
}
