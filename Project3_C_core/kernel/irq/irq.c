...
void init_exception()
{
    ...
    */
    ...
    exc_table[EXCC_STORE_ACCESS]         = (void *)handle_other;
    exc_table[EXCC_INST_PAGE_FAULT]      = (void *)handle_other;
    exc_table[EXCC_LOAD_PAGE_FAULT]      = (void *)handle_other;

    printl("begin setup_exception\n");
    ...
    */
    ...
    irq_table[IRQC_S_EXT]                 = (void *)handle_other;
